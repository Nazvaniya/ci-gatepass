  ...
  <table id="tbl_goods" class="table table-striped table-bordered p-auto" style="max-width: 100%">
        ...
        <tbody>
            <tr>
                ...
                <td>0 Unit</td>
                <td class="col-sm-1">
                <input type="number" min="1" max="" class="" style="max-width:50px" id="qty_return" name="qty_return" disabled>
                </td class="col-sm-1">
                <td class="">  
                <div class="form-check">
                <input class="checkbox" type="checkbox" id="cb_return" value="option1" aria-label="..."disabled>
                </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a type="button" class="btn btn-primary d-none" href="<?php echo base_url('logistic/dashboard/loaned');?>">Save</a>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <table class="table table-bordered table-sm">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Loaned Balance</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <h4>Return Date: <?php echo date('d-m-Y', strtotime(date('d-m-Y') . "-2days"));?></h4>
                    <table class="table table-bordered table-sm">
                        <thead>
                            <tr>
                                <th scope="col">No</th>
