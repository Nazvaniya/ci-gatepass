    ...
    <div class="jumbotron jumbotron-fluid px-5 py-3">
        <div  class="row">
            ...
            <div class="col-sm-10"> 
              ...
              <p class="lead">Welcome Laksemana Lufti.</p>
            </div>
        </div>
    </div>
...
<table id="example" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
        ...
        <tbody>
            <tr>
                ...
                <td><?= date("d-m-Y") ?></td>
                <td>
                    <a href="<?= base_url("logistic/detail_fg_approval/approved"); ?>">
                    FG-M/0122/0004
                    </a>
                </td>
                <td>Gunawan</td>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url("logistic/detail_fg_approval/loaned"); ?>">
                    FG-M/0122/0002
                    </a>
                </td>
                <td>Gunawan</td>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url("logistic/detail_fg_approval/rejected"); ?>">
                    FG-M/0122/0001
                    </a>
                </td>
                <td>Gunawan</td>
