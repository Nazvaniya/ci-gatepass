...
<div class="container mt-2">
    ...
    <div class="row">
      <div class="col-6">
        ...
        <label for="inputReturn">Jenis Gate Pass</label>
          <select  class="form-control">
            ...
            <option value="EHS">Logistic</option>
         </select>
        </div>
        ...
        <label for="inputReturn">Jenis Limbah</label>
          <select id="type_waste" class="form-control">
            ...
            <option id="chemical_waste">Limbah Berbahaya</option>
            <option id="scrap_waste">Limbah Scrap</option>
            <option id="general_waste">Limbah General</option>
          </select>
        </div>
        <div class="form-group">
        <label for="inputReturn">Departemen</label>
          <select id="selectType" class="form-control" >
            <option value="">Semua</option>
            <option id="">EHS</option>
            <option id="">BMO</option>
            <option id="">Logistic</option>
          </select>
        </div>
        <div class="form-group">
      ...
      <div class="form-group">
        ...
        <label for="inputReturn">Vendor</label>
          <select id="selectType" class="form-control" >
            <option value="">ALL</option>
            <option id="">PT. Desa Air Cargo</option>
            <option id="">PT. Sadar Nursada</option>
            <option id="">PT. Himalaya</option>
          </select>
        </div>
      </div>
    ...
    <button type="button" class="btn btn-primary btn-sm text-white"><i class="bi bi-file-earmark-arrow-down-fill"></i>Expor</button>
    </div>
</div>
