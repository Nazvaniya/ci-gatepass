...
<div class="container mt-1">
    ...
    <div class="card px-5 py-2 shadow">
        <div  class="row">
            ...
            <div class="col-sm-11 p-2"> 
              <h5 class="display-5">Detail Scrap Waste Gate Pass</h5>
            </div>
        </div>
    </div>
    ...
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link active"  href="<?= base_url('security/detail/scrap_info'); ?>">Informasi Utama</a>
      </li>
      <li class="nav-item">
        <a class="nav-link"  href="<?= base_url('security/detail/scrap_verify'); ?>">Informasi Barang</a>
      </li>
    </ul>
    </div>
  </div>
