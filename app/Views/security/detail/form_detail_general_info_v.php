...
<div class="container mt-1">
    ...
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link active" href="<?= base_url('security/detail/general_info'); ?>">informasi utama</a>
      </li>
      <li class="nav-item">
        <a class="nav-link"  href="<?= base_url('security/detail/general_verify'); ?>">Informasi Barang</a>
      </li>
    </ul>
    </div>
  </div>
