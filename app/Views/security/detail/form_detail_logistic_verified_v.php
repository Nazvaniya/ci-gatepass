...
<div class="container mt-1">
    ...
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link"  href="<?= base_url('security/detail/logistic_info'); ?>">Informasi Utama</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active"  href="<?= base_url('security/detail/logistic_verify'); ?>">Informasi Barang</a>
      </li>
    </ul>
  </div>
    </div>
