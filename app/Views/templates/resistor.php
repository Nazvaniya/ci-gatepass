            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url('resistor/index'); ?>">Dashboard <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="<?= base_url('bmo/datamaster/list'); ?>">Vendor</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?= base_url('resistor/create'); ?>">General</a>
                        </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?= base_url('resistor/recordlist/all'); ?>">All Gate pass</a>
                            <a class="dropdown-item" href="<?= base_url('resistor/recordlist/inprogress'); ?>">Gate pass In Progress</a>
                            <a class="dropdown-item" href="<?= base_url('resistor/recordlist/completed'); ?>">Gate pass Completed</a>
                            <a class="dropdown-item" href="<?= base_url('resistor/recordlist/rejected'); ?>">Gate pass Rejected </a>
                            <a class="dropdown-item" href="<?= base_url('resistor/recordlist/loaned'); ?>">Loaned goods</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('resistor/report'); ?>">Report</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('resistor/search'); ?>">Search</a>
                    </li>
                </ul>
            </div>
        </div>
