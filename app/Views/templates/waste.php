    ...
    <body class="d-flex flex-column min-vh-100 body-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <li class="nav-item dropdown">
                ...
                <a  class="dropdown-item"  class="dropdown-toggle" class="btn-group dropright" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"href="#">Limbah</a>
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('ehs/create/hazardous');?>" class="dropdown-item">Limbah Berbahaya</a></li>
                                <li><a href="<?= base_url('ehs/create/scrap');?>" class="dropdown-item">Limbah Scrap</a></li>
                                <li><a href="<?= base_url('ehs/create/general');?>" class="dropdown-item">Limbah General</a></li>
                            </ul>       
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('ehs/search');?>">Pencarian</a>
            </li>
            </ul>
        </div>
        </div>
