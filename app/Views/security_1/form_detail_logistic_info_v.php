...
<div class="container mt-1">
  ...
  <div class="form-row p-1">
  <div class="form-group col-sm-4">
      <label for="data_return_type">Return Type</label>
      <input type="text" class="form-control" id="data_return_type" name="data_return_type" value="Unreturnable" readonly>
    </div>
    <div class="form-group col-sm-4" id="data_remark_reason">
      <label for="data_remark_reason">Remark</label>
      <input type="text" class="form-control"  name="data_remark_reason" value="Tropolish" readonly>
    </div>
    <div class="form-group col-sm-4 invisible" id="data_expected_date">
    ...
    <div class="form-group col-sm-4 invisible" id="data_actual_date">
