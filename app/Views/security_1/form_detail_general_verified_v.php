...
<div class="container mt-1">
    ...
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="<?= base_url('home/infogoods'); ?>">Goods Information</a>
      </li>
    </ul>
  </div>
    </div>
  ...
  <table id="tbl_goods" class="table table-striped table-bordered p-auto" style="max-width: 100%">
        ...
        <tbody>
            <tr>
                ...
                <td>Unit</td>
                <td>Re-work</td>
                <td><img id="access" alt="image" src="<?= base_url('/image/bowl.png'); ?>"></td>
                <td>
...
<div class="col-auto">  
<button type="button" class="btn btn-primary" id="btn_verified" data-toggle="modal" data-target="#scan_modal" disabled>Verified</button>
</div>
  </div>
</div>
