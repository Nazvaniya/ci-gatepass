   ...
   Permintaan Perpanjangan Tanggal: <a href="#" data-toggle="modal" data-target="#approve_extend">Detail</a>
    ...
    <div class="">
      ...
      <div class="form-group col-sm-3">
        ...
        <div class="form-group col-sm-3">
          <label for="inputApprovalStatus">Penyetuju Pengajuan</label>
      ...
      <div class="form-group p-2 px-4 row justify-content-end d-none">
      ...
      <div class="row p-3 justify-content-end ">
        ...
        <div class="mx-1"><button type="button" class="btn btn-danger" id="btn_disapproved" data-toggle="modal" data-target="#rejectModal">Menolak</button></div>
        <div class="mx-1"><button type="button" class="btn btn-primary" id="btn_approved" data-toggle="modal" data-target="#approveModal">Menyetujui</button></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a type="submit" class="btn btn-dark" href="<?php echo base_url('/bmo/authorizer/rejected'); ?>">Iya, Konfirmasi</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
          <a type="submit" class="btn btn-primary" href="<?php echo base_url('/bmo/authorizer/approved'); ?>">Iya, Konfirmasi</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <table id="tbl_extend" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td> <input type="text" class="form-control" name="remark_extend" value="suku cadang belum tiba" readonly></td>
                  <!-- <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal" type="button">Return goods</button> -->
                  </td>
                </tr>
                <tr>
            ...
            <table class="table table-bordered table-sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td>scan function is also trouble</td>
