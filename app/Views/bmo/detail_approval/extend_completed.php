  ...
  <div class="card mt-3 shadow card-body">
    <div class="">
      ...
      <div class="row p-3 justify-content-end ">
        <div class="mx-1"><a type="button" onClick="history.go(-1);" href="<?php echo base_url('/bmo/authorizer/extend_completed');?>"class="btn btn-dark">Back</a></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a type="submit" class="btn btn-primary" href="<?php echo base_url('/bmo/detail/extend_waiting'); ?>">Save</a>
        </div>
      </div>
    </div>
  </div>
