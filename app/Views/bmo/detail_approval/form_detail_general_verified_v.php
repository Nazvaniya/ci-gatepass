...
<div class="mx-1"><button type="button" class="btn btn-primary d-none" id="btn_disapproved">Reject</button></div>
<div class="mx-1"><button type="button" class="btn btn-primary d-none" id="btn_approved">Approve</button></div>
