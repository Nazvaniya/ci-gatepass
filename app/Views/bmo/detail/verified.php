    ...
    <div class="">
      ...
      <div class="form-group col-sm-3">
        ...
        <div class="form-group col-sm-3">
          ...
          <input type="text" class="form-control" id="action_take_validation" value="<?php echo date('d-m-Y H:i', strtotime(date('d-m-Y H:i') . "+1 Hours")); ?>" readonly>
        </div>
        <div class="form-group col-sm-3">
      ...
      <div class="form-group p-2 px-4 row justify-content-end">
            ...
            <table id="tbl_goods" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
              <thead>
                ...
                <th style="width: 25px">No</th>
                  <th>Jenis Barang</th>
                  <th>Qty</th>
                  <th style="width: 150px">Jenis Pengembalian</th>
                  <th>Status</th>
                  <th style="width: 150px">Sisa Dipinjamkan</th>
                  <th>Keterangan</th>
                  <th>Estimasi Kembali <a href="#" data-toggle="modal" data-target="#extend_date"><i class="bi bi-pencil-fill"></i></a></th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+5days")); ?></td>
                  <td><img id="access" data-toggle="modal" data-target="#popup_image2" src="<?= base_url('/image/reader.jpg'); ?>"></td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="row p-3 justify-content-end ">
        <div class="mx-1"><button type="button" onClick="history.go(-1);" class="btn btn-dark">Kembali</button></div>
...
<div class="mx-1"><button type="button" class="btn btn-primary" id="btn_approved">Approve</button></div> -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Perpanjang Tanggal</h5>
        ...
        <table id="tbl_extend" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>RFID Card</td>
                  <td><input type="text" class="form-control" name="old_data_expected_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+2days")); ?>" disabled></td>
                  <td><input type="date" class="form-control" name="new_expected_date"></td>
                  <td> <input type="text" class="form-control" name="remark_extend"></td>
                  <!-- <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal" type="button">Return goods</button> -->
                  </td>
                </tr>
                <tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a type="button" class="btn btn-dark" href="<?= base_url('home/general_detail'); ?>">Yes, Confirm</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal custom fade" id="returning_goods" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Mengembalikan Barang</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="form-group col-sm-4">
            <label for="inputissued">Keterangan</label>
            <input type="text" class="form-control" id="remark_return" value="">
        </div>
        </div>
          <div class="row p-2">
            <div class="mb-3 col-sm-12">
              <div class="table-responsive">
                <table id="tbl_goods" class="table table-striped table-bordered table-sm p-auto" style="max-width: 100%">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Jenis Barang</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="col-sm-1">
                        <input type="number" min="1" max="" class="" style="max-width:50px" id="qty_return2" name="qty_return">
                      </td>
                      <td class="col-sm-1">
                        <div class="form-check">
                          <input class="checkbox" type="checkbox" id="cb_return2" onclick="all2()" value="option1" aria-label="...">
                        </div>
                        <!-- <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal" type="button">Return goods</button> -->
                      </td>
                    </tr>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
          <a class="btn btn-primary" id="confirm" href="<?= base_url('/bmo/detail/partial'); ?>">Simpan</a>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  var input2 = document.getElementById("qty_return2");
