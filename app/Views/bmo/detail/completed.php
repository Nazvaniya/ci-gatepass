    ...
    <div class="">
          ...
          <div class="table-responsive">
            <table class="table table-borderless" id="tbl_info">
              ...
              <tr>
                <td>Goods Status</td>
                <td>:</td>
                <td id="goods_status">Completed</td>
                <td>Section</td>
                <td>:</td>
                <td>SFPO</td>
      ...
      <div class="form-row p-2">
        ...
        <div class="form-group col-sm-4" id="data_actual_date">
          ...
          <input type="text" class="form-control" name="data_actual_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+3days")); ?>" readonly>
        </div>
      </div>
      ...
      <div class="row p-3 justify-content-end ">
        <div class="mx-1"><a type="button" href="<?= base_url('/bmo/dashboard/completed'); ?>" onClick="history.go(-1);" class="btn btn-dark">Back</a></div>
        ...
        <div class="modal-body">
          <div class="form-row p-2">
            <div class="form-group col-sm-4" id="data_expected_date">
              ...
              <input type="text" class="form-control" name="old_data_expected_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+5days")); ?>" disabled>
            </div>
            <div class="form-group col-sm-4" id="data_expected_date">
                ...
                <table id="tbl_goods" class="table table-striped table-bordered p-auto" style="max-width: 100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="col-sm-1">
                        <div class="form-check">
                          <input class="checkbox" type="checkbox" id="cb_return2" value="option1" aria-label="...">
                        </div>
                        <!-- <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal" type="button">Return goods</button> -->
                      </td>
                    </tr>
          ...
          <div>
            ...
            <table class="table table-bordered table-sm">
              ...
              <tbody>
                ...
                <tr>
                  <td scope="row">2</th>
                  <td><?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+0days")); ?></td>
                  <td>4</td>
                  <td>2</td>
                  <td>2</td>
                </tr>
