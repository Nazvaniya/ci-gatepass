    ...
    <div class="">
      ...
      <div class="form-row p-2">
        <div class="form-group col-sm-4" id="data_expected_date">
          ...
          <input type="text" class="form-control" name="data_expected_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+2days")); ?>" readonly>
          <small class="text-danger">*Waiting Extend Date Approval</small>
        </div>
            ...
            <table id="tbl_goods" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Loaned</td>
                  <td>1 Unit</td>
                  <td>to repair the printer</td>
                  <td><img id="access" data-toggle="modal" data-target="#popup_image" src="<?= base_url('/image/printer.jpg'); ?>"></td>
        ...
        <div class="modal-body">
          <div class="form-row p-2">
            <div class="form-group col-sm-4" id="data_expected_date">
              ...
              <input type="text" class="form-control" name="old_data_expected_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+2days")); ?>" disabled>
            </div>
            <div class="form-group col-sm-4" id="data_expected_date">
              <label for="data_expected_date">New Expected Date</label>
              <input type="text" class="form-control" name="new_expected_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+5days")); ?>">
            </div>
            <div class="form-group col-sm-4" id="remark_extend">
              <label for="data_expected_date">Remark</label>
              <input type="text" class="form-control" name="remark_extend" value="spare parts have not arrived">
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <a type="button" class="btn btn-primary" href="<?php echo base_url('/bmo/detail/extend'); ?>">cancel</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal custom fade" id="returning_goods" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
                ...
                <table id="tbl_goods" class="table table-striped table-bordered p-auto" style="max-width: 100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>1 Unit</td>
                      <td>to repair the printer</td>
                      <td> <img id="access" src="<?= base_url('/image/printer.jpg'); ?>"></td>
                      <td class="col-sm-1">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <a class="btn btn-primary" href="<?= base_url('/bmo/detail/partial'); ?>">Save</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="popup_image" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="<?php echo base_url('/image/printer.jpg'); ?>" style="width:100%;height:100%;">
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
