...
<?= $this->section('ehs/form_detail_revision_chemical_v') ?>
  ...
  <table id="example" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
        <thead>
            <tr>
                ...
                <th>Manifest No.</th>
                <th>Qty</th>
                <th style="width: 160px">Before Weight(Kg)</th>
                <!-- <th>Return Type</th> -->
                <th style="width: 150px">After Weight(Kg)</th>
            </tr>
        </thead>
        <tbody>
            <tr>
