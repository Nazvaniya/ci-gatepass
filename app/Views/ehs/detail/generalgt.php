    ...
    <div class="">
          ...
          <div class="table-responsive">
            <table class="table table-borderless" id="tbl_info">
              <tr>
                <td>Date</td>
                <td>:</td>
                <td><?php echo date('05-01-2021'); ?></td>
      ...
      <div class="form-row p-2">
        <div class="form-group col-sm-4">
          <label for="inputApprovalStatus">Submission Status</label>
        ...
        <div class="form-group col-sm-4">
          ...
          <input type="text" class="form-control" id="action_take_approve" value="<?php echo date('d-m-Y 09:12'); ?>" readonly>
        </div>
        <div class="form-group col-sm-4">
          <label for="inputApprover">Submission Approver</label>
          <input type="text" class="form-control" id="approval_name" value="Chalid Zamzami" readonly>
        </div>
      </div>
      <div class="form-row p-2">
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
          ...
          <input type="text" class="form-control" id="action_take_validation" value="<?php echo date('d-m-Y 09:30'); ?>" readonly>
        </div>
        <div class="form-group col-sm-4">
      ...
      <div class="form-row p-2">
        <div class="form-group col-sm-4">
          <label for="returntype">Submission Rejected Reason</label>
          <input type="text" class="form-control" id="return_dis" value="N/A" readonly>
        </div>
        <div class="form-group col-sm-4">
          <label for="Remark">Security Rejected Reason</label>
      ...
      <div class="form-row p-2">
        <div class="form-group col-sm-4" id="data_expected_date">
          ...
          <!-- <small class="text-danger">*Waiting changed approval (18-01-2022 to 30-01-2022)</small> -->
        </div>
            ...
            <table id="tbl_goods" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td>N/A</td>
                  <td>Personal used</td>
                  <td> <img id="access" src="<?= base_url('/image/carton box.jpg'); ?>"></td>
