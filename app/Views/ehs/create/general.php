...
<div class="container mt-2">
    ...
    <div class="card px-5 py-3 shadow">
        <div  class="row">
            ...
            <div class="col-sm-11 p-2"> 
              <h5 class="display-5">Pengajuan Limbah General Gate Pass</h5>
            </div>
        </div>
    </div>
    ...
    <div class="form-group col-sm-4">
      ...
      <input type="text" class="form-control" id="no_gatepass" value="EHS-G/EHS/0004" readonly name="gatepass_no">
    </div>
    <div class="form-group col-sm-4">
    ...
    <div class="form-group col-sm-4">
      ...
      <input type="text" class="form-control" id="typeofwaste" placeholder="General" value="General" readonly name="waste_type">
    </div>
  </div>
  <div class="form-row p-2">
    <div class="form-group col-sm-4">
      <label for="inputissued">Dikeluarkan Oleh</label>
      <input type="text" class="form-control" id="issued"  value="April" readonly name="issued">
    </div>
    <div class="form-group col-sm-4">
...
<div class="form-group col-sm-4">
    ...
    <div class="form-group col-sm-4">
      ...
      <select class="select2 form-control" id="name_driver" name="driver_name" data-placeholder="Pilih Driver">
      <option></option>
        ...
        <table class="table table-sm">
          <thead>
            <tr>
                    ...
                    <!-- <th style="width: 175px">Return of Type</th> -->
          ...
          <tbody id="goodslist">
            <tr>
              ...
              <select class="select2 form-control" name="type_goods[]" data-placeholder="Pilih Limbah">
                    ...
                    <option>Woodent Waste</option>
                    <option>Gyfsum waste</option>
                    <option>Sampah basah/Canteen waste</option>
               </select>
              </td>
              <td>
