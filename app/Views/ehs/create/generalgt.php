...
<div class="container mt-2">
    ...
    <div class="form-group col-sm-4">
      ...
      <input type="text" class="form-control" id="no_gatepass" value="General/BMO/0003" readonly>
    </div>
    <div class="form-group col-sm-4">
  ...
  <div class="form-row p-2">
    ...
    <div class="form-group col-sm-4">
      ...
      <input type="text" class="form-control" id="department" name="department" placeholder="BMO" value="EHS" readonly>
    </div>
    <div class="form-group col-sm-4">
