  ...
  <div class="jumbotron jumbotron-fluid px-5 py-3">
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <p class="lead">Selamat Datang April.</p>
      </div>
    </div>
  </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body mt-3 text-center">
              ...
              <p class="card-text">
                <a href="<?= base_url("ehs/recordlist/inprogress"); ?>" class="text-dark">
                  Dalam Proses
                </a>
            </div>
          </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body mt-3 text-center">
              ...
              <p class="card-text">
                <a href="<?= base_url("ehs/recordlist/completed"); ?>" class="text-success">
                  Selesai
                </a>
            </div>
          </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body px-2 mt-3 text-center">
              ...
              <p class="card-text">
                <a href="<?= base_url("ehs/recordlist/rejected"); ?>" class="text-danger">
                  Ditolak
                </a>
              </p>
            </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body px-2 mt-3 text-center">
              ...
              <p class="card-text">
                <a href="<?= base_url("ehs/recordlist/loaned"); ?>" class="text-warning">
                  Dipinjamkan
                </a>
            </div>
          </div>
