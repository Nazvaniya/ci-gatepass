...
<?= $this->section('ehs/form_add_general_waste_v') ?>
<div class="container mt-2">
    ...
    <div class="card px-5 py-3 shadow">
        <div  class="row">
            ...
            <div class="col-sm-11 p-2"> 
              <h5 class="display-5">Request Gate Pass General Waste</h5>
            </div>
        </div>
    </div>
  ...
  <div class="form-row p-2">
    <div class="form-group col-sm-4">
      ...
      <input type="text" class="form-control" id="issued"  value="User" readonly name="issued">
    </div>
    <div class="form-group col-sm-4">
        ...
        <table class="table table-sm">
          <thead>
            <tr>
                    ...
                    <th style="width: 155px">Type of Unit</th>
