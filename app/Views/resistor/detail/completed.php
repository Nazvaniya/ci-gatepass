  ...
  <div class="card mt-3 shadow card-body">
    <div class="">
      ...
      <div class="row p-3 justify-content-end ">
        <div class="mx-1"><a type="button" href="<?= base_url('/resistor/dashboard/completed'); ?>"class="btn btn-dark">Back</a></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a type="button" id="confirm" class="btn btn-dark" href="<?= base_url('#'); ?>">Yes, Confirm</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal custom fade" id="returning_goods" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
                ...
                <table id="tbl_goods" class="table table-striped table-bordered p-auto" style="max-width: 100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>0 Pcs</td>
                      <td>Send to Terra</td>
                      <td> <img id="access" src="<?= base_url('/image/stick.jpg'); ?>"></td>
                      <td class="col-sm-1">
                        <input type="number" min="1" max="" class="" style="max-width:50px" id="qty_return" name="qty_return">
                      </td class="col-sm-1">
                      <td class="">
                        <div class="form-check">
                          <input class="checkbox" type="checkbox" onclick="all1()" id="cb_return" value="option1" aria-label="...">
                        </div>
                        <!-- <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal" type="button">Return goods</button> -->
                      </td>
                    </tr>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <a type="button" class="btn btn-primary" href="<?= base_url('/resistor/detail/completed'); ?>">Save</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal custom fade" id="return_log" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div>
            <h4>Goods: Grinding Welding Electrode Lower </h4>
            <table class="table table-bordered table-sm">
              <thead>
                <tr>
                  <th scope="col">No</th>
