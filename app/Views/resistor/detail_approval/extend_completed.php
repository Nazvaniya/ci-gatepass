    ...
    <div class="">
      ...
      <div class="form-row p-2">
        <div class="form-group col-sm-4" id="data_expected_date">
          ...
          <input type="text" class="form-control" name="data_expected_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+3days")); ?>" readonly>
        </div>
        ...
        <div class="modal-body">
          <div class="form-row p-2">
            <div class="form-group col-sm-4" id="data_expected_date">
              ...
              <input type="text" class="form-control" name="old_data_expected_date" value="<?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+3days")); ?>" disabled>
            </div>
            <div class="form-group col-sm-4" id="data_expected_date">
