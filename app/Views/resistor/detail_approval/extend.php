      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-row p-2">
            ...
            <div class="form-group col-sm-4" id="remark_extend">
              <label for="data_expected_date">Remark</label>
              <input type="text" class="form-control" name="remark_extend" value="Vendor waiting some materials" readonly>
            </div>
          </div>
          <div>
            <h5>History:</h5>
            <table class="table table-bordered table-sm">
              ...
              <tbody>
                <tr>
                  <th scope="row">1</th>
                  <td><?php echo date('d-m-Y', strtotime(date('d-m-Y') . "-2days")); ?></td>
                  <td><?php echo date('d-m-Y', strtotime(date('d-m-Y') . "-1days")); ?> to <?php echo date('d-m-Y', strtotime(date('d-m-Y') . "+0days")); ?></td>
                  <td>Vendor waiting PO</td>
                  <td><?php echo date('d-m-Y', strtotime(date('d-m-Y') . "-1days")); ?></td>
                  <td>Approved by Yoseph</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="modal-footer">
          ...
          <a type="button" class="btn btn-primary" href="<?php echo base_url('/resistor/detail_approval/extend_completed'); ?>">Approve</a>
        </div>
      </div>
    </div>
  </div>
