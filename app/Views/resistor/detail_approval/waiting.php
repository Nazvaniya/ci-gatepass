  ...
  <div class="card mt-3 shadow card-body">
    ...
    <div class="">
      ...
      <div class="row p-3 justify-content-end ">
        ...
        <div class="mx-1"><button type="button" class="btn btn-danger" id="btn_disapproved" data-toggle="modal" data-target="#rejectModal">Reject</button></div>
        <div class="mx-1"><button type="button" class="btn btn-primary" id="btn_approved" data-toggle="modal" data-target="#approveModal">Approve</button></div>
  ...
  <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
          <a type="submit" class="btn btn-dark" href="<?php echo base_url('/resistor/authorizer/rejected'); ?>">Yes, Confirm</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <a type="submit" class="btn btn-primary" href="<?php echo base_url('/resistor/authorizer/approved'); ?>">Yes, Confirm</a>
        </div>
      </div>
    </div>
  </div>
