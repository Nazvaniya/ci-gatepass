    ...
    <div class="col-sm-3">
      <div class="card mb-3 shadow" style="max-width: 350px;">
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body mt-3 text-center">
              <h1 class="card-title text-success font-weight-bold">6</h1>
              <p class="card-text">
      ...
      <table id="example" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <a href="<?= base_url("resistor/detail_approval/extend"); ?>">
              General/RES/2202/0008
              </a>
            </td>
            <td>Syarifuddin</td>
            <td>Resistor</td>
            <td><span class="badge badge-warning">Waiting Extend Date Approval</span></td>
          </tr>
          <tr>
            <td>2</td>
            <td><?= date("d-m-Y") ?></td>
            <td>
              <a href="<?= base_url("resistor/detail_approval/completed"); ?>">
