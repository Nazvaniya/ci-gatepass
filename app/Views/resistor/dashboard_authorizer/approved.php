        ...
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body mt-3 text-center">
              <h1 class="card-title font-weight-bold">1</h1>
              <p class="card-text">
    ...
    <div class="col-sm-3">
      <div class="card mb-3 shadow" style="max-width: 350px;">
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body mt-3 text-center">
              <h1 class="card-title text-success font-weight-bold">5</h1>
              <p class="card-text">
    ...
    <div class="col-sm-3">
      <div class="card mb-3 shadow" style="max-width: 350px;">
        <div class="row no-gutters">
          <div class="col-md-8">
            <div class="card-body px-2 mt-3 text-center">
              <h1 class="card-title text-warning font-weight-bold">3</h1>
              <p class="card-text">
      ...
      <table id="example" class="table table-striped table-bordered p-auto table-sm" style="max-width: 100%">
        ...
        <tbody>
          <tr>
            ...
            <td><?= date("d-m-Y") ?></td>
            <td>
              <a href="<?= base_url("resistor/detail_approval/approved"); ?>">
              General/RES/2202/0011
              </a>
            </td>
            <td>Syarifuddin</td>
            <td>Resistor</td>
            <td><span class="badge badge-warning">Waiting Submission Verify</span></td>
          </tr>
          <tr>
            <td>2</td>
            <td><?= date("d-m-Y") ?></td>
            <td>
              <a href="<?= base_url("resistor/detail_approval/verified"); ?>">
              General/RES/2202/0010
              </a>
            </td>
            <td>Muhammad Rizky Kurniawan</td>
            <td>Resistor</td>
          ...
          <tr>
            ...
            <td>
              <a href="<?= base_url("resistor/detail_approval/verified"); ?>">
              General/RES/2202/0007
              </a>
            </td>
            <td>Galih Galuh Giri Gilberto</td>
            <td>Resistor</td>
            <td><span class="badge badge-info">Loaned</span></td>
          </tr>
          <tr>
